...
function preload() {
  ...
  //backSound=loadSound("Dance Chill Out.wav")
...
function move() {
 if (keyIsDown(LEFT_ARROW)) {
  ...
  if (keyCode===32) {
    if (bulletCurrent=1 && bulletnum>1) {
      bulletnum-=0.5
...
/*function aliensTouching () {
 ...
 }else if (aline2.x>=500) {
  console.log("Game Over")
 } else if (alien3.x>=500) {
  console.log("Game Over")
 }else if (alien4.x>=500) {
  console.log("Game Over")
 }else if (alien5.x>=500) {
  console.log("Game Over")
 }else if (alien6.x>=500) {
  console.log("Game Over")
 }else if (alien7.x>=500) {
  console.log("Game Over")
 }else if (alien8.x>=500) {
  console.log("Game Over")
 }else if (alien9.x>=500) {
  console.log("Game Over")
 }else if (alien10.x>=500) {
  console.log("Game Over")
 } else {
